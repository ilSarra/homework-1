public class Ogre implements Character {
    private static final double DEFAULT_ATTACK = 4;
    private static final double DEFAULT_DEFENCE = 4;
    ...
    private static final double MOUNTAIN_ATTACK_POWER_UP = 1;
    private static final double MOUNTAIN_DEFENCE_POWER_UP = 1;

    private static final double DAY_ATTACK_POWER_UP = 0.5;
    private static final double DAY_DEFENCE_POWER_UP = 0.5;
    private static final double NIGHT_ATTACK_POWER_UP = 1.5;
    private static final double NIGHT_DEFENCE_POWER_UP = 1.5;
